...
-->
                    <inertia-link class="inline-block" :href="route('project.edit', row.id)" tabindex="-1">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     ...
                     <inertia-link class="inline-block  items-center" :href="route('project.status', [row.id, row.status])" tabindex="-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
